...
public class AddProductFormController implements Initializable {
    ...
    private final ObservableList<Part> allAssocParts = FXCollections.observableArrayList();
    ...
    void saveHandler(ActionEvent event) {
        ...
        try {
            ...
            Product newProduct = new Product(Inventory.generateProductId(), name, price, inv, min, max);
